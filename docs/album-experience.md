# Made In Chicago album experience
...
- [Label release announcement](https://thesrg-ilsgroup.com/lalah-hathaway-releases-new-album-made-in-chicago/)
- [Album presave](https://srgils.lnk.to/MadeInChicago)
- [Current single](https://srgils.lnk.to/CantLetGo)
- Album cover: original official Linkfire artwork linked by the label, downloaded at 440 × 440.
- Photograph and Magic Vintage font: supplied project assets. The WOFF file compresses the original TTF without changing the design.

Release actions reflect the label's presave status checked on September 5, 2026. Update `lib/release.ts` when the campaign changes to full-album listening.

The artist's final biography, contact inbox, and email platform are still pending from the original brief. Existing preview forms stay truthful about their delivery state. No missing artist quotes, studio footage, or form destinations have been invented.
